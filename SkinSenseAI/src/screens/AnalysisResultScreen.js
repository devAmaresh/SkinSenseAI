      ...
      >
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View className="px-6 space-y-6">
            ...
            {/* Key Ingredients */}
            {ensureArray(result.key_ingredients).length > 0 && (
              <View 
                className="rounded-2xl p-4"
                style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.03)',
              ...
              >
                ...
                <View className="space-y-2">
                  {ensureArray(result.key_ingredients).map((ingredient, index) => (
                    <View key={index} className="flex-row items-start">
                      <Ionicons name="ellipse" size={8} color="#00f5ff" style={{ marginTop: 6 }} />
                      <View className="ml-2 flex-1">
                        <Text className="text-gray-300 capitalize font-medium">
                          {typeof ingredient === 'string' ? ingredient : ingredient.name}
                        </Text>
                        {typeof ingredient !== 'string' && ingredient.description && (
